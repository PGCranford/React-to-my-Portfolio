        ...
        <section class="hero is-fullheight" className={styles["resume-image"]}>
            <div class="hero-body">
                <div class="has-text-centered" >
                    <a class=" is-size-2-mobile" className={styles["resume-link"]} href="https://docs.google.com/document/d/149r0ZQtq28xd6zszK5IMEyq1MGJ2kAdNmVzKNMYLhAY/edit?usp=sharing" > 🖱️Resume🖱️</a>
                </div>
